...
export function PortfolioHero(){
 ...
 return <section className="portfolio-cover" aria-labelledby="cover-title">
  <nav className="cover-nav" aria-label="Main navigation"><a href="#about">ABOUT</a><a href="#content">CONTENT</a><a href="#projects">PROJECTS</a><a href="#resume">RESUME</a></nav>
